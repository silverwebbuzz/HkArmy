	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-12 mb-2 mt-1">
				<div class="row">
					<div class="col-12">
						<h3 class="content-header-title float-left pr-1 mb-0">{{ __('languages.awards.edit_awards') }}</h3>
					</div>
				</div>
			</div>
		</div>
		<div class="content-body new-user">
			<section class="users-edit">
				<div class="card">
					...
					<form action="{{ route('awards.update',$Awards->id) }}" method="POST" id="addAwardsForm" name="addAwardsForm" enctype='multipart/form-data'>
						@csrf()
						@method('patch')
							<div class="card-body">
								<div class="form-row">
									<div class="form-group col-md-6 mb-50">
										...
										<input type="text" class="form-control" id="award_name_en" name="name_en" placeholder="{{ __('languages.awards.award_name_en') }}" value="{{$Awards->name_en}}">
									...
									<div class="form-group col-md-6 mb-50">
										...
										<input type="text" class="form-control" id="award_name_ch" name="name_ch" placeholder="{{ __('languages.awards.award_name_ch') }}" value="{{$Awards->name_ch}}">
								...
								<div class="form-row">
									...
									<div class="form-group col-md-6 mb-50">
										...
										<select class="form-control" id="award_year" name="award_year">
											...
											<?php
											for($i = 2000 ; $i <= 2050; $i++){ ?>
												<option value="{{$i}}" @if($i == $Awards->award_year) selected @endif>{{$i}}</option>
											<?php }
											?>
										</select>
								...
								@php
								$CheckCategoriesIsOther = App\Helpers\Helper::CheckCategoriesIsOther($Awards->award_categories_id);
								@endphp
								<div class="form-row" id="other-awards-type-section" <?php if($CheckCategoriesIsOther == 'false'){ echo 'style="display:none;"';}?>>
									<div class="form-group col-md-6 mb-50">
										<label class="text-bold-600" for="other_awards_type_en">{{__('languages.awards.other_award_type_english')}}</label>
										<input type="text" class="form-control" id="other_awards_type_en" name="other_awards_type_en" placeholder="{{__('languages.awards.other_award_type_english')}}" value="{{$Awards->other_awards_type_en}}">
									...
									<div class="form-group col-md-6 mb-50">
										...
										<input type="text" class="form-control" id="other_awards_type_ch" name="other_awards_type_ch" placeholder="{{__('languages.awards.other_award_type_chinese')}}" value="{{$Awards->other_awards_type_ch}}">
								...
								<div class="form-row">
									<div class="form-group col-md-6 mb-50">
										...
										<input type="text" class="form-control" id="reference_number" name="reference_number" placeholder="{{__('languages.awards.reference_number')}}" value="{{$Awards->reference_number}}">
