	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-12 mb-2 mt-1">
				<div class="row">
					<div class="col-12">
						<h3 class="content-header-title float-left pr-1 mb-0">{{ __('languages.Categories.Add_Categories') }}</h3>
					</div>
				</div>
			</div>
		</div>
			...
			<section class="users-edit">
				<div class="card">
					<div class="card-content">
						<form action="{{ route('categories.store') }}" method="POST" id="categoriesForm" name="categoriesForm">
						<input type="hidden" name="_token" id="csrf-token" value="{{ csrf_token() }}">
							<div class="card-body">
								<div class="form-row">
									<div class="form-group col-md-6 mb-50">
										<label class="text-bold-600" for="chinesecategories">{{ __('languages.Categories.Chinese_Categories') }}</label>
										<input type="text" class="form-control" id="chinesecategories" name="chinesecategories_name" placeholder="{{ __('languages.Size_Attributes.Ch_Place_Holder') }}" value="">
									</div>
									<div class="form-group col-md-6 mb-50">
										<label class="text-bold-600" for="englishcategories">{{ __('languages.Categories.English_Categories') }}</label>
										<input type="text" class="form-control" id="englishcategories" name="englishcategories_name" placeholder="{{ __('languages.Size_Attributes.En_Place_Holder') }}" value="">
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-6 mb-50">
