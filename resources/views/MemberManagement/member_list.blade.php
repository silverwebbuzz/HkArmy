				...
				<form action="{{ url('members-list') }}" method="get" name="filterDateForm" id="filterDateForm">
						...
						<div class="float-right align-items-center col-md-3">
							...
							<fieldset class="form-group">
								<select class="form-control" id="filtergender" name="filtergender">
									<option value="">{{ __('languages.member.select') }}</option>
									<option value="1">{{ __('languages.member.Male') }}</option>
									<option value="2">{{ __('languages.member.Female') }}</option>
								</select>
							</fieldset>
						</div>
						<!-- <div class="float-right align-items-center col-md-3">
					...
					<div class="row">
						<!-- <div class="form-group col-md-2">
							...
							<fieldset class="form-group position-relative has-icon-left">
								<input type="text" class="form-control filterdateofBirth" id="filterdateofBirth" name="dateofbirth" placeholder="{{ __('languages.Select_date') }}" autocomplete="off">
								...
								<select class="form-control" id="filterrealtedactivity" name="filterrealtedactivity[]" multiple="multiple">
									@if(!empty($RelatedActivityHistory))
										...
										@foreach($RelatedActivityHistory as $val)
											<option value="{{ $val[$ActivityHistory] }}"> {{ $val[$ActivityHistory] }}</option>
										@endforeach
									@endif
								</select>
							</fieldset>
					...
					<div class="row">
							...
							<fieldset class="form-group">
								<select class="form-control" id="filterqualification" name="filterqualification">
									...
									@if($Qualification)
										...
										<option value="{{ $val['id'] }}">{{ $val['qualification_'.app()->getLocale()] }}</option>
										@endforeach
									@endif
								</select>
							</fieldset>
						...
						<div class="form-group col-md-2">
							...
							<fieldset class="form-group position-relative has-icon-left">
								<input type="text" class="form-control filterjoindate" id="filterjoindate" name="filterjoindate" placeholder="{{ __('languages.Select_date') }}" autocomplete="off">
								<div class="form-control-position">
									<i class="bx bx-calendar-check"></i>
								</div>
							</fieldset>
						...
						<div class="form-group col-md-2">
							...
							<input type="text" class="form-control filterhourpoint" id="filterhourpoint" name="filterhourpoint" placeholder="{{ __('languages.member.Hour_Point') }}" autocomplete="off">
						</div>
						...
						<div class="form-group serach-member-btn">
							<div class="form-group align-items-center">
								<h4>{{ __('languages.member.Total_user') }} :<span class="total_filter_users">{{ count($users) }}</span> </h4>
							</div>
						</div>
					</div>
				</form>
				...
				<div class="users-list-table">
					<div class="card">
						<div class="card-content">
							<div class="card-body">
								<div class="table-responsive member-table-cls">
...
<input type="hidden" name="search_event_date" id="search_event_date" value="">
<input type="hidden" name="search_event_type" id="search_event_type" value="">
<!-- footer content -->
