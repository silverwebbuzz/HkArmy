	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-12 mb-2 mt-1">
				<div class="row">
					<div class="col-12">
						<h3 class="content-header-title float-left pr-1 mb-0">{{ __('languages.Qualification.Add_Qualification') }}</h3>
					</div>
				</div>
			</div>
		</div>
			...
			<section class="users-edit">
				<div class="card">
					<div class="card-content">
						<form action="{{ url('qualification') }}" method="POST" id="qualificationForm" name="qualificationForm">
							...
							<div class="card-body">
								<div class="form-row">
									<div class="form-group col-md-6 mb-50">
										...
										<input type="text" class="form-control" id="chinesequalification" name="chinesequalification" placeholder="" value="">
									</div>
									<div class="form-group col-md-6 mb-50">
										<label class="text-bold-600" for="englishqualification">{{ __('languages.Qualification.English_Qualification') }}</label>
										<input type="text" class="form-control" id="englishqualification" name="englishqualification" placeholder="" value="">
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-6 mb-50">
