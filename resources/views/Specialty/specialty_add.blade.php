	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-12 mb-2 mt-1">
				<div class="row">
					<div class="col-12">
						<h3 class="content-header-title float-left pr-1 mb-0">{{ __('languages.Specialty.Add_Specialty') }}</h3>
					</div>
				</div>
			</div>
		</div>
			...
			<section class="users-edit">
				<div class="card">
					<div class="card-content">
						<form action="{{ url('specialty') }}" method="POST" id="specialtyForm" name="specialtyForm">
						<input type="hidden" name="_token"  id="csrf-token" value="{{ csrf_token() }}">
							<div class="card-body">
								<div class="form-row">
									<div class="form-group col-md-6 mb-50">
										<label class="text-bold-600" for="ChineseSpecialty">{{ __('languages.Specialty.Chinese_Specialty') }}</label>
										<input type="text" class="form-control" id="chinesespecialty" name="chinesespecialty" placeholder="" value="">
									</div>
									<div class="form-group col-md-6 mb-50">
										<label class="text-bold-600" for="englishqualification">{{ __('languages.Specialty.English_Specialty') }}</label>
										<input type="text" class="form-control" id="englishspecialty" name="englishspecialty" placeholder="" value="">
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-6 mb-50">
