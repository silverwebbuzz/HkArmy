	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-12 mb-2 mt-1">
				<div class="row">
					<div class="col-12">
						<h3 class="content-header-title float-left pr-1 mb-0">{{ __('languages.UserManagement.update_user') }}</h3>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="col-12">
						...
						<div class="card">
							<div class="card-content">
								<form action="{{route('user-management.update',$userData->ID)}}" method="POST" id="editUserForm" name="UserForm" class="editUserForm" autocomplete="off">
									{{ method_field('PUT') }}
									...
									<div class="card-body">
										<div class="form-row">
												...
												<fieldset class="form-group">
													<select class="form-control" id="role_type" name="role_type">
                                                        ...
                                                        @foreach($roleData as $role)
                                                            <option value="{{$role->id}}" @if($role->id == $userData->Role_ID) selected="selected"  @endif>{{$role->role_name}}</option>
                                                        @endforeach
														@endif
													</select>
												</fieldset>
											...
											<div class="form-group col-md-6 mb-50">
												...
												<input type="text" class="form-control" id="userName" name="userName" placeholder="{{ __('languages.UserManagement.user_name') }}" value="{{$userData->UserName}}">
										...
										<div class="form-row">
											<div class="form-group col-md-6 mb-50">
												...
												<input type="text" class="form-control" id="englishName" name="englishName" placeholder="{{ __('languages.UserManagement.english_name') }}" value="{{$userData->English_name}}">
											...
											<div class="form-group col-md-6 mb-50">
												...
												<input type="text" class="form-control" id="chineseName" name="chineseName" placeholder="{{ __('languages.UserManagement.chinese_name') }}" value="{{$userData->Chinese_name}}">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6 mb-50">
                                                ...
                                                <ul class="list-unstyled mb-0">
                                                    <li class="d-inline-block mt-1 mr-1 mb-1">
                                                        <fieldset>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input" name="gender" id="male" value="1" @if($userData->Gender == '1') checked @endif>
                                                    ...
                                                    <li class="d-inline-block my-1 mr-1 mb-1">
                                                        <fieldset>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" class="custom-control-input" name="gender" id="female" value="2" @if($userData->Gender == '2') checked @endif>
											...
											<div class="form-group col-md-6 mb-50">
												...
												<input type="text" class="form-control" id="email" name="email" placeholder="{{ __('languages.UserManagement.email') }}" value="{{$userData->email}}">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6 mb-50">
												...
												<input type="text" class="form-control" id="contact_no" name="contact_no" placeholder="{{ __('languages.UserManagement.contact_no') }}" value="{{$userData->Contact_number}}" maxlength="8">
                                            ...
                                            <div class="form-group col-md-6 mb-50">
                                                ...
                                                <fieldset class="form-group">
                                                    <select class="form-control" id="Status" name="Status">
                                                        <option value="1" @if($userData->Status == 1) selected @endif>{{ __('languages.Active') }}</option>
                                                        <option value="2" @if($userData->Status == 2) selected @endif>{{ __('languages.Inactive') }}</option>
                                                    </select>
                                                </fieldset>
                                            </div>
                                        </div>
