								...
								<div class="card-body pb-1">
									<div class="d-flex justify-content-around align-items-center flex-wrap">
										<div class="user-analytics">
											...
											<div class="d-flex">
												<div id="user-count-chart" data-users="{{ $total_users}}"></div>
												<h3 class="mt-1 ml-50">{{ $total_users }}</h3>
											</div>
										</div>
										...
										<div class="user-analytics">
											<i class="bx bx-user mr-25 align-middle"></i>
											<span class="align-middle text-muted">{{ __('languages.Mentor Team Member') }}</span>
											<div class="d-flex">
												<div id="mentor-user-count-chart" data-mentor-users="{{ $total_mentor_users}}"></div>
												<h3 class="mt-1 ml-50">{{ $total_mentor_users }}</h3>
											</div>
										</div>
										<div class="user-analytics">
											<i class="bx bx-user mr-25 align-middle"></i>
											<span class="align-middle text-muted">{{ __('languages.Elite Team Member') }}</span>
											<div class="d-flex">
												<div id="elite-user-count-chart" data-elite-users="{{ $total_elite_users}}"></div>
												<h3 class="mt-1 ml-50">{{ $total_elite_users }}</h3>
											</div>
										</div>
										<div class="user-analytics">
											<i class="bx bx-user mr-25 align-middle"></i>
											<span class="align-middle text-muted">{{ __('languages.District Team Member') }}</span>
											<div class="d-flex">
												<div id="district-user-count-chart" data-district-users="{{ $total_district_users}}"></div>
												<h3 class="mt-1 ml-50">{{ $total_district_users }}</h3>
											</div>
										</div>
									</div>
                                    ...
                                    <!-- <div class="btn-group mb-1">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 31px, 0px);">
                                                <a class="dropdown-item graph-options" type="daily" href="javascript:void(0);">Daily</a>
                                                <a class="dropdown-item graph-options" type="weekly" href="javascript:void(0);">Weekly</a>
                                                <a class="dropdown-item graph-options" type="monthly" href="javascript:void(0);">Monthly</a>
                                            </div>
                                        </div>
                                    </div> -->

                                    <!-- Start Graph Canvas -->
									<!-- <div class="user-count-year"></div> -->
                                    <!-- End Graph Canvas -->
