    ...
    <div class="sm-right-detail-sec import-pages-header pl-5 pr-5">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="sec-title">
                        <h2 class="mb-4">{{__('Import Award Member')}}</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="sm-add-user-sec card">
                <div class="select-option-sec pb-5 card-body">
                    ...
                    @endif
                    <form class="user-form" method="post" id="importAwardMember"  action="{{ route('import-award-assign-member-list') }}" enctype="multipart/form-data">
                        @csrf()
