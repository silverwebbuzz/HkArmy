$(function () {
    ...
    $(document).on("click", ".productAssignMember", function () {
        ...
        var product_id = $(this).attr("modal-product-id");
        ...
        $.ajax({
            type: "POST",
            url: BASE_URL + "/product/getEventMember",
            data: {
                _token: $('meta[name="csrf-token"]').attr("content"),
                product_id: product_id,
            },
    ...
    $(document).on("change", ".product_assign_status_change", function () {
        var event_id = $(this).attr("data-product-id");
        var status = $(this).children("option:selected").val();
        var id = $(this).children("option:selected").attr("data-id");
        if (confirm("Are you sure you want to confirm this?")) {
            $.ajax({
                type: "GET",
                url: BASE_URL + "/productAssignChangeStatusUpdate/" + id,
                data: {
                    status: status,
                    _token: $('meta[name="_token"]').attr("content"),
                    event_id: event_id,
...
$(document).on("click", ".export-export_attendance_event_member", function () {
    // Select rows from table_id
    var check_dataTables_empty = document.querySelectorAll(".dataTables_empty"); //get .datatable_empty row
    var rows = document.querySelectorAll("table#attendanceReporttable tr");
    if (rows.length == 0) {
        var rows = document.querySelectorAll("table#search-eventtable tr");
    }
    if (check_dataTables_empty.length == 1) {
        ...
        // Download it
        var filename = "AttendanceEventMember.csv";
...
$(document).on("click", ".export-assign-user-report", function () {
    // Select rows from table_id
    var check_dataTables_empty = document.querySelectorAll(".dataTables_empty"); //get .datatable_empty row
    var rows = document.querySelectorAll("table#assignUserReportTbl tr");
    if (rows.length == 0) {
        var rows = document.querySelectorAll("table#assignUserReport tr");
    }
    if (check_dataTables_empty.length == 1) {
        toastr.error("No Any Data");
    } else {
        ...
        var csv_string = csv.join("\n");
        // Download it
        var filename = "AssignUserReport.csv";
        var link = document.createElement("a");
        link.style.display = "none";
        link.setAttribute("target", "_blank");
        link.setAttribute(
...
$(document).on("click", ".export_roles", function () {
    // Select rows from table_id
    var check_dataTables_empty = document.querySelectorAll(".dataTables_empty"); //get .datatable_empty row
    var rows = document.querySelectorAll("table#rolemanagemnttable tr");
    if (check_dataTables_empty.length == 1) {
        toastr.error("No Any Data");
    } else {
        // Construct csv
...
$(document).on("click", ".export-product-assign-user-report", function () {
    ...
    if (check_dataTables_empty.length == 1) {
        ...
        var csv_string = csv.join("\n");
        // Download it
        var filename = "ProductAssignUserReport.csv";
        var link = document.createElement("a");
        link.style.display = "none";
        link.setAttribute("target", "_blank");
        link.setAttribute(
...
$(document).on("click", ".export-products", function () {
    // Select rows from table_id
    var check_dataTables_empty = document.querySelectorAll(".dataTables_empty"); //get .datatable_empty row
    var rows = document.querySelectorAll("table#productTable tr");
    if (check_dataTables_empty.length == 1) {
        toastr.error("No Any Data");
    } else {
        // Construct csv
...
$(document).on("click", ".export-product-transaction_history", function () {
    ...
    if (check_dataTables_empty.length == 1) {
        ...
        var csv_string = csv.join("\n");
        // Download it
        var filename = "ProductTransactionHistory.csv";
        var link = document.createElement("a");
        link.style.display = "none";
        link.setAttribute("target", "_blank");
        link.setAttribute(
        ...
        if ($("#member-table").length) {
            ...
            $(document).on("click", ".dt-checkboxes", function () {
                ...
                if ($(this).is(":checked")) {
                    ...
                    // const index = useridarr.indexOf(userid.toString());
                    // if (index > -1) {
